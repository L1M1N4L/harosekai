              ...
              >
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                  <div className="text-center p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl hover:shadow-lg hover:shadow-slate-500/10 transition-all duration-500 transform  hover:-translate-y-1 border border-slate-200/50">
                    <div className="text-3xl font-bold text-slate-900 mb-2">{blogs.length}</div>
                    <div className="text-sm text-slate-600 font-medium">Blogs</div>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl hover:shadow-lg hover:shadow-slate-500/10 transition-all duration-500 transform  hover:-translate-y-1 border border-slate-200/50">
                    <div className="text-3xl font-bold text-slate-900 mb-2">{academia.length}</div>
                    <div className="text-sm text-slate-600 font-medium">Academic Papers</div>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl hover:shadow-lg hover:shadow-slate-500/10 transition-all duration-500 transform  hover:-translate-y-1 border border-slate-200/50">
                    <div className="text-3xl font-bold text-slate-900 mb-2">{technicalWritings.length}</div>
                    <div className="text-sm text-slate-600 font-medium">Technical Guides</div>
                  </div>
                  <div className="text-center p-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl hover:shadow-lg hover:shadow-slate-500/10 transition-all duration-500 transform  hover:-translate-y-1 border border-slate-200/50">
                    <div className="text-3xl font-bold text-slate-900 mb-2">35+</div>
                    <div className="text-sm text-slate-600 font-medium">Total Articles</div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-4 sm:py-6">
          ...
          <nav className="flex items-center">
            <div className="flex items-center space-x-2 text-sm">
              ...
              <span className="text-slate-900 font-medium">Writings</span>
            </div>
          </nav>
        </div>
      </header>
